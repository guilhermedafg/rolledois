# Rolle — Público e personas

## Prioridade
1. **Agora: criador de conteúdo de nicho** (gastronomia, café, comida) em Curitiba.
2. **Depois: usuário final** (o seguidor que confia no criador). Vira foco com a integração por DM do Instagram.
3. **Futuro: estabelecimentos** (possível fonte de receita via dados de intenção).
...
## Persona 2: o seguidor (usuário final, depois)
- Mora em Curitiba ou está visitando, e quer decidir rápido para onde ir.
- Confia mais em uma pessoa do que em nota de avaliação.
- Salva posts no Instagram e nunca mais acha.
- Ganho: entra no perfil do criador no Rolle, filtra, vê no mapa e vai.

## Persona 3: o dono do negócio (futuro)
- Pessoas por trás de cafés, restaurantes e bares de Curitiba.
- Hoje: protagonista de conteúdo (pilar "pessoas"). Amanhã: possível cliente.
