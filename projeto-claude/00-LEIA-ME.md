...
Fundação do "braço direito" de estratégia e conteúdo do Rolle.
...
3. Suba os demais arquivos (`02` a `09`) em **Conhecimento do projeto** (Project knowledge).
...
| `05-marca-e-voz.md` | Tom de voz v0 (a construir junto), referências, identidade visual | Conhecimento |
